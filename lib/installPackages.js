...
function install(name, path){
    ...
    return new Promise((resolve, reject) => {
        exec("npm install express swagger-express-mw@0.1.0 log4js bluebird mongoose https://github.com/capiotsoftware/cuti.git https://github.com/capiotsoftware/puttu-redis.git https://github.com/capiotsoftware/swagger-mongoose-crud --save",
